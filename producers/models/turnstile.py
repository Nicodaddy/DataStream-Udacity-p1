...
class Turnstile(Producer):
    key_schema = avro.load("models/schemas/turnstile_key.json")

    #
    # TODO: Define this value schema in `schemas/turnstile_value.json, then uncomment the below
    #
    value_schema = avro.load("models/schemas/turnstile_value.json")
    ...
    def __init__(self, station):
        ...
        print(f"This is Turnstile, station is: {self.station.color}")
